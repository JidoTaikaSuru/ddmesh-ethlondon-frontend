                ...
                <div className="w-2/3 m-auto px-5 flex justify-center items-center flex-col">
                    ...
                    {(() => {
                        if (step === 1) {
                                    ...
                                    <CardContent className={"flex-col space-y-2"}>
                                        <Form {...form}>
                                            ...
                                            >
                                                ...
                                                />
                                                <div
                                                    className="w-4/5 mx-auto px-2 mb-0 pb-0 flex flex-row flex-columns-2 gap-6 justify-between items-center">
                                                    <RenderMESHInWeek
                            ...
                            //TODO Give people some starter DDMesh here
                            return (
                                <Card className="min-w-96 w-2/3">
                                    <CardHeader>
                                    ...
                                    <CardContent className={"flex flex-col space-y-2"}>
                                        <img src={DDMeshLogo} className={"h-20"}/>
                                        <p>Happy hacking!</p>
                                    </CardContent>
                                </Card>
                            );

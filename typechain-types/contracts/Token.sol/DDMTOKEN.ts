...
export interface DDMTOKENInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "DOMAIN_SEPARATOR"
...
export interface DDMTOKEN extends BaseContract {
  connect(runner?: ContractRunner | null): DDMTOKEN;
  waitForDeployment(): Promise<this>;

  interface: DDMTOKENInterface;
